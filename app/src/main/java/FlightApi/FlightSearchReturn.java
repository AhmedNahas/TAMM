...
public class FlightSearchReturn implements Serializable {

    private final static long serialVersionUID = 4603163176326649018L;
     ...
     * @param journeyType
     */
    public FlightSearchReturn(String iPAddress, String endUserBrowserAgent, String pointOfSale, String requestOrigin, String tokenId, long journeyType, long adultCount, long childCount, long infantCount, List<Segment> segment, Object preferredCarrier) {
        super();
    ...
    public FlightSearchReturn withIPAddress(String iPAddress) {
        this.iPAddress = iPAddress;
        return this;
    }
    ...
    public FlightSearchReturn withEndUserBrowserAgent(String endUserBrowserAgent) {
        this.endUserBrowserAgent = endUserBrowserAgent;
        return this;
    }
    ...
    public FlightSearchReturn withPointOfSale(String pointOfSale) {
        this.pointOfSale = pointOfSale;
        return this;
    }
    ...
    public FlightSearchReturn withRequestOrigin(String requestOrigin) {
        this.requestOrigin = requestOrigin;
        return this;
    }
    ...
    public FlightSearchReturn withTokenId(String tokenId) {
        this.tokenId = tokenId;
        return this;
    }
    ...
    public FlightSearchReturn withJourneyType(long journeyType) {
        this.journeyType = journeyType;
        return this;
    }
    ...
    public FlightSearchReturn withAdultCount(long adultCount) {
        this.adultCount = adultCount;
        return this;
    }
    ...
    public FlightSearchReturn withChildCount(long childCount) {
        this.childCount = childCount;
        return this;
    }
    ...
    public FlightSearchReturn withInfantCount(long infantCount) {
        this.infantCount = infantCount;
        return this;
    }
    ...
    public FlightSearchReturn withSegment(List<Segment> segment) {
        this.segment = segment;
        return this;
    }

    public Object getPreferredCarrier() {
        return preferredCarrier;
    }

    public void setPreferredCarrier(Object preferredCarrier) {
        this.preferredCarrier = preferredCarrier;
    }

    public FlightSearchReturn withPreferredCarrier(Object preferredCarrier) {
        this.preferredCarrier = preferredCarrier;
        return this;
    }
    ...
    public class Segment implements Serializable {
        ...
        private final static long serialVersionUID = 5675309464062524208L;
         ...
         * @param destination
         */
        public Segment(String origin, String destination, String preferredDepartureTime, String preferredArrivalTime, long flightCabinClass, List<String> preferredAirlines) {
            super();
            this.origin = origin;
        ...
        public Segment withFlightCabinClass(long flightCabinClass) {
            this.flightCabinClass = flightCabinClass;
            return this;
        }
