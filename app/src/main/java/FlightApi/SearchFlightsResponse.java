...
public class SearchFlightsResponse implements Serializable {
    ...
    private final static long serialVersionUID = -6428729149046446002L;
     ...
     * @param isSuccess
     */
    public SearchFlightsResponse(List<List<Result>> results, boolean isSuccess, List<Object> errors, List<Object> alerts, String tokenId, String trackingId) {
        super();
    ...
    public SearchFlightsResponse withResults(List<List<Result>> results) {
        this.results = results;
        return this;
    }
    ...
    public SearchFlightsResponse withIsSuccess(boolean isSuccess) {
        this.isSuccess = isSuccess;
        return this;
    }
    ...
    public SearchFlightsResponse withErrors(List<Object> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public SearchFlightsResponse withAlerts(List<Object> alerts) {
        this.alerts = alerts;
        return this;
    }
    ...
    public SearchFlightsResponse withTokenId(String tokenId) {
        this.tokenId = tokenId;
        return this;
    }
    ...
    public SearchFlightsResponse withTrackingId(String trackingId) {
        this.trackingId = trackingId;
        return this;
    }
    ...
    public class FareRule implements Serializable {
        ...
        private final static long serialVersionUID = 4230431961433844443L;
         ...
         * @param destination
         */
        public FareRule(String origin, String destination, String airline, String fareRestriction, String fareBasisCode, Object fareRuleDetail, String departureDate, Object flightNumber) {
            super();
            this.origin = origin;
    ...
    public class Result implements Serializable {
        ...
        private final static long serialVersionUID = -6641633028276863342L;
         ...
         * @param responseTime
         */
        public Result(String resultId, String origin, String destination, boolean isLcc, boolean nonRefundable, String airlineRemark, Fare fare, List<FareBreakdown> fareBreakdown, String lastTicketDate, String ticketAdvisory, List<List<Segment>> segments, List<FareRule> fareRules, String validatingAirline, String responseTime, long journeyType) {
            super();
        ...
        public Result withLastTicketDate(String lastTicketDate) {
            this.lastTicketDate = lastTicketDate;
            return this;
        }
        ...
        public Result withTicketAdvisory(String ticketAdvisory) {
            this.ticketAdvisory = ticketAdvisory;
            return this;
        }
