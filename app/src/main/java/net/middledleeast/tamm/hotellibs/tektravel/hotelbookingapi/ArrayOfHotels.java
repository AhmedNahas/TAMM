...
/**
 * <p>Java class for ArrayOfHotels complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Hotel" type="{http://TekTravel/HotelBookingApi}Hotels" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ArrayOfHotels", propOrder = {
    "hotel"
})
public class ArrayOfHotels {

    @XmlElement(name = "Hotel", nillable = true)
    protected List<Hotels> hotel;
