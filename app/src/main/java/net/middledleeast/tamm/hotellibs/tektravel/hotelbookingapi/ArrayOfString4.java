 ...
 *       &lt;sequence&gt;
 *         &lt;element name="HotelFacility" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ArrayOfString4 {
    ...
    protected List<String> hotelFacility;
     ...
     * This is why there is not a <CODE>set</CODE> method for the hotelFacility property.
     * 
     * <p>
    ...
    public List<String> getHotelFacility() {
        if (hotelFacility == null) {
            hotelFacility = new ArrayList<String>();
        }
