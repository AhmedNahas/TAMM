 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Attraction" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ArrayOfString3 {
    ...
    @XmlElement(name = "Attraction", nillable = true)
    protected List<String> attraction;
