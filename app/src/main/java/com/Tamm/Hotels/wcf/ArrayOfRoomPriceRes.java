...
public class ArrayOfRoomPriceRes extends Vector<RoomPriceRes> implements KvmSerializable {
    ...
    public void loadFromSoap(java.lang.Object inObj, ExtendedSoapSerializationEnvelope __envelope) {
        ...
        for (int i0 = 0; i0 < size; i0++) {
            ...
            if (obj != null && obj instanceof AttributeContainer) {
                ...
                RoomPriceRes j1 = (RoomPriceRes) __envelope.get(j, RoomPriceRes.class, false);
                add(j1);
            }
        }
    }
