...
public class ArrayOfImageUrlDetails extends Vector<ImageUrlDetails> implements KvmSerializable {
    ...
    public void loadFromSoap(java.lang.Object inObj, ExtendedSoapSerializationEnvelope __envelope) {
        ...
        for (int i0 = 0; i0 < size; i0++) {
            ...
            if (obj != null && obj instanceof AttributeContainer) {
                ...
                ImageUrlDetails j1 = (ImageUrlDetails) __envelope.get(j, ImageUrlDetails.class, false);
                add(j1);
            }
        }
    }
