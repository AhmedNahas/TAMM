...
public class ArrayOfHotel_Result extends Vector<Hotel_Result> implements KvmSerializable {
    ...
    public void loadFromSoap(java.lang.Object inObj, ExtendedSoapSerializationEnvelope __envelope) {
        ...
        for (int i0 = 0; i0 < size; i0++) {
            ...
            if (obj != null && obj instanceof AttributeContainer) {
                ...
                Hotel_Result j1 = (Hotel_Result) __envelope.get(j, Hotel_Result.class, false);
                add(j1);
            }
        }
    }
