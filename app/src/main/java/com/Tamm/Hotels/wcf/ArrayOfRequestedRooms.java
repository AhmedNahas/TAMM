...
public class ArrayOfRequestedRooms extends Vector<RequestedRooms> implements KvmSerializable {
    ...
    public void loadFromSoap(java.lang.Object inObj, ExtendedSoapSerializationEnvelope __envelope) {
        ...
        for (int i0 = 0; i0 < size; i0++) {
            ...
            if (obj != null && obj instanceof AttributeContainer) {
                ...
                RequestedRooms j1 = (RequestedRooms) __envelope.get(j, RequestedRooms.class, false);
                add(j1);
            }
        }
    }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "HotelRoom";
        info.type = RequestedRooms.class;
