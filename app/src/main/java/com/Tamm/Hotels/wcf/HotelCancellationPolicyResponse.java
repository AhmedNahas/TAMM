...
public class HotelCancellationPolicyResponse extends AttributeContainer implements KvmSerializable {
    ...
    public ArrayOfString2 HotelNorms;
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("HotelNorms")) {
            if (obj != null) {
                java.lang.Object j = obj;
                this.HotelNorms = (ArrayOfString2) __envelope.get(j, ArrayOfString2.class, false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if (propertyIndex == 2) {
            return this.HotelNorms != null ? this.HotelNorms : SoapPrimitive.NullSkip;
        }
        return null;
    }
