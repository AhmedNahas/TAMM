...
public class AmendGuestRes extends AttributeContainer implements KvmSerializable {


    public Enums.AmendActionRes Action = Enums.AmendActionRes.Retained;
    ...
    public void loadFromSoap(java.lang.Object paramObj, ExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (inObj.hasAttribute("Action")) {
            ...
            if (j != null) {
                Action = Enums.AmendActionRes.fromString(j.toString());
            }
        }
