...
public class ArrayOfAPIHotelDetails extends Vector<APIHotelDetails> implements KvmSerializable {
    ...
    public void loadFromSoap(java.lang.Object inObj, ExtendedSoapSerializationEnvelope __envelope) {
        ...
        for (int i0 = 0; i0 < size; i0++) {
            ...
            if (obj != null && obj instanceof AttributeContainer) {
                ...
                APIHotelDetails j1 = (APIHotelDetails) __envelope.get(j, APIHotelDetails.class, false);
                add(j1);
            }
        }
    }
