...
public class Supplement extends AttributeContainer implements KvmSerializable {
    ...
    public Boolean SuppIsMandatory = false;
    ...
    public void loadFromSoap(java.lang.Object paramObj, ExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (inObj.hasAttribute("SuppIsMandatory")) {
            java.lang.Object j = inObj.getAttribute("SuppIsMandatory");
            if (j != null) {
                SuppIsMandatory = new Boolean(j.toString());
            }
        }
    ...
    public void getAttributeInfo(int index, AttributeInfo info) {
        ...
        if (index == 3) {
            info.name = "SuppIsMandatory";
            info.namespace = "";
            if (this.SuppIsMandatory != null) {
                info.setValue(this.SuppIsMandatory);
            }
        ...
        if (index == 6) {
            ...
            if (this.CurrencyCode != null) {
                info.setValue(this.CurrencyCode);
            }
