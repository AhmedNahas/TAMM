...
public class AmendmentDetails extends AttributeContainer implements KvmSerializable {
    ...
    public BigDecimal CreditNoteAmount = BigDecimal.ZERO;

    public BigDecimal DebitNoteAmount = BigDecimal.ZERO;
    ...
    public void loadFromSoap(java.lang.Object paramObj, ExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (inObj.hasAttribute("CreditNoteAmount")) {
            java.lang.Object j = inObj.getAttribute("CreditNoteAmount");
            if (j != null) {
                CreditNoteAmount = new BigDecimal(j.toString());
            }
        }
        if (inObj.hasAttribute("DebitNoteAmount")) {
            java.lang.Object j = inObj.getAttribute("DebitNoteAmount");
            if (j != null) {
                DebitNoteAmount = new BigDecimal(j.toString());
            }
        }
    ...
    public void getAttributeInfo(int index, AttributeInfo info) {
        ...
        if (index == 2) {
            info.name = "CreditNoteAmount";
            info.namespace = "";
            if (this.CreditNoteAmount != null) {
                info.setValue(this.CreditNoteAmount);
            }

        }
        if (index == 3) {
            info.name = "DebitNoteAmount";
            info.namespace = "";
            if (this.DebitNoteAmount != null) {
                info.setValue(this.DebitNoteAmount);
            }
